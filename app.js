			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$PhotoGroove$Small,
						_Utils_eq(chosenSize, $author$project$PhotoGroove$Small)),
						A2(
						$author$project$PhotoGroove$viewSizeChooser,
						$author$project$PhotoGroove$Medium,
						_Utils_eq(chosenSize, $author$project$PhotoGroove$Medium)),
						A2(
						$author$project$PhotoGroove$viewSizeChooser,
						$author$project$PhotoGroove$Large,
						_Utils_eq(chosenSize, $author$project$PhotoGroove$Large))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
